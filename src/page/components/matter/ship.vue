     ...
     <div class="centre">
       <div class="information">
           ...
           <div class="informationCentre">
             <p class="text"><span class="textItem">代理人：</span><span class="textspan"></span></p>
             <p class="text"><span class="textItem">进入或穿越区域：</span><span class="textspan"></span></p>
           </div>
           <div class="informationRight">
             <p class="text"><span class="textItem">联系人：</span><span class="textspan"></span></p>
             <p class="text"><span class="textItem">进入或穿越时间：</span><span class="textspan"></span></p>
           </div>
       </div>
       <!--     受理的事件详情-开始-->
       <div class="DataBack">
         <el-collapse   v-model="activeNames" @change="DataBackChange">
           <div class="shipInformation">
             <el-collapse-item name="2">
               ...
               <el-collapse class="shipList"  v-model="shipNames">
                 <el-collapse-item :title="'大船'" :name="index">
                   <div class="system">
                     <div class="systemLeft">
                       <p class="text"><span class="textItem">船舶名称：</span><span class="textspan"></span></p>
                       <p class="text"><span class="textItem">型深：</span ><span class="textspan"></span></p>
                       <p class="text"><span class="textItem">载客(吨)：</span><span></span></p>
                     </div>
                     <div class="systemCentre">
                       <p class="text"><span class="textItem">船舶种类：</span><span></span></p>
                       <p class="text"><span class="textItem">吃水(米)：</span><span></span></p>
                       <p class="text"><span class="textItem">其他使用情况：</span><span></span></p>
                     </div>
                     <div class="systemRight">
                       <p class="text"><span class="textItem">型宽：</span><span></span></p>
                       <p class="text"><span class="textItem">载客(位)：</span><span></span></p>
                     </div>
                   </div>
                 </el-collapse-item>
               </el-collapse>
