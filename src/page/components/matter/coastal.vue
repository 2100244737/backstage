     ...
     <div class="centre">
       <div class="information">
           <div class="informationLift">
             ...
             <p class="text"><span class="textItem">规划范围：</span><span class="textspan"></span></p>
           </div>
           <div class="informationCentre">
             ...
             <p class="text"><span class="textItem">建设单位：</span><span class="textspan"></span></p>
           </div>
           <div class="informationRight">
             <p class="text"><span class="textItem">申请类型：</span><span class="textspan"></span></p>
             <p class="text"><span class="textItem">规划期限：</span><span class="textspan"></span></p>
           </div>
       </div>
       <!--     受理的事件详情-开始-->
       <div class="DataBack">
